        ...
        this.description = {
            ...
            properties: [
                    ...
                    options: [
                        {
                            ...
                            description: 'Get every field, constraint, gotcha, and a valid example for one project element type',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            description: 'Get a validated, layout-clean starting point that demonstrates professional Zvid composition patterns',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            description: 'Get the plan-aware JSON Schema, validation notes, professional authoring guidelines, and required workflow before composing a project',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            description: 'List visual, audio, subtitle, and scene elements with required fields and professional layout guidance',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            description: 'Create a plan-aware storyboard, creative direction, library searches, and anti-repetition strategy before authoring project JSON',
                            routing: {
                                request: {
                                    method: 'POST',
                                    url: '/api/render/creative-plan/api-key',
                                },
                                send: { preSend: [GenericFunctions_1.buildCreativePlanBody] },
                            },
                        },
                        {
                            ...
                            description: 'Conservatively fix mechanical JSON mistakes and return every change, remaining error, and professional layout warning',
                            routing: {
                                request: {
                                    method: 'POST',
                                ...
                                send: {
                                    preSend: [GenericFunctions_1.buildRepairBody],
                                },
                            },
                        },
                    ],
                    ...
                    options: [
                        {
                            ...
                            description: 'Get the full JSON content: complete project JSON for examples or a reusable design/canvas/shape module for other kinds',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            description: 'Get title, description, preview, thumbnail, content URL, and other metadata',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            description: 'Search complete project examples, animated design templates, canvas presets, or shapes and inspect their preview metadata',
                            routing: {
                                request: {
                                    method: 'GET',
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            description: 'Search normalized stock image, video, GIF, or music results with preview and full-quality render URLs',
                            routing: {
                                request: {
                                    method: 'GET',
                    ...
                    options: [
                        {
                            ...
                            routing: {
                                ...
                                send: {
                                    preSend: [GenericFunctions_1.buildRenderBody],
                                },
                                output: {
                        ...
                        },
                        {
                            ...
                            routing: {
                                ...
                                send: {
                                    preSend: [GenericFunctions_1.buildBulkRenderBody],
                                },
                            },
                        },
                        {
                            ...
                            value: 'get',
                            action: 'Get a render',
                            description: 'Get a render job status and output URL, optionally waiting for completion',
                            routing: {
                                request: {
                                    method: 'GET',
                        ...
                        },
                        {
                            ...
                            routing: {
                                ...
                                send: {
                                    preSend: [GenericFunctions_1.addRenderListQuery],
                                },
                                output: {
                                    postReceive: [
                                        {
                        ...
                        },
                        {
                            ...
                            description: 'Run the real backend validation (template resolution + your plan limits) without rendering or spending credits — returns valid or field-level errors',
                            routing: {
                                request: {
                                    method: 'POST',
                                ...
                                output: {
                                    postReceive: [GenericFunctions_1.normalizeValidationResponse],
                                },
                            },
                        },
                    ],
                    ...
                    options: [
                        {
                            ...
                            description: 'Create and validate a reusable video or image template from AI-authored project JSON',
                            routing: {
                                request: { method: 'POST', url: '/api/templates' },
                                send: { preSend: [GenericFunctions_1.buildTemplateCreateBody] },
                            },
                        },
                        {
                            name: 'Delete (Archive)',
                            ...
                            description: 'Archive an owned active template so it can no longer be rendered or updated',
                            routing: {
                                request: {
                                    method: 'DELETE',
                        ...
                        },
                        {
                            ...
                            description: 'Create an active editable copy of an owned template, including an archived template',
                            routing: {
                                request: {
                                    method: 'POST',
                        ...
                        },
                        {
                            ...
                            routing: {
                                ...
                                send: {
                                    preSend: [GenericFunctions_1.buildPreviewBody],
                                },
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Update the name, description, and/or validated project JSON of an owned active template',
                            routing: {
                                request: {
                                    method: 'PUT',
                                    url: '=/api/templates/{{$parameter.templateId}}',
                                },
                                send: { preSend: [GenericFunctions_1.buildTemplateUpdateBody] },
                            },
                        },
                    ],
                    default: 'render',
                ...
                },
                {
                    ...
                    type: 'json',
                    default: '[]',
                    description: 'JSON array of recently used creative-library slugs to avoid in fresh or explore mode',
                    displayOptions: { show: { resource: ['authoring'], operation: ['planCreativeVideo'] } },
                },
                {
                ...
                },
                {
                    ...
                    default: 'project',
                    description: 'Whether the LLM needs the project payload shape or the complete API request envelope',
                    displayOptions: {
                ...
                },
                {
                    ...
                    name: 'elementType',
                    type: 'options',
                    options: ['IMAGE', 'VIDEO', 'GIF', 'SVG', 'TEXT', 'AUDIO', 'SUBTITLE', 'SCENE'].map((value) => ({ name: value, value })),
                    default: 'TEXT',
                    displayOptions: {
                ...
                },
                {
                    ...
                    default: '{}',
                    required: true,
                    description: 'Project JSON to repair. For AI Agent use, let the model supply the generated project object.',
                    displayOptions: {
                ...
                },
                {
                    ...
                    default: '{}',
                    required: true,
                    description: 'Full Zvid project spec (scenes, elements, output settings). Use the Validate operation (or the @zvid/mcp get_project_schema tool) to check AI-generated or expression-built JSON before rendering — the backend validation is the source of truth.',
                    displayOptions: {
                        show: {
                            resource: ['render'],
                            operation: ['create', 'createBulk', 'validate'],
                ...
                },
                {
                    ...
                    default: '{}',
                    required: true,
                    description: 'Complete project JSON. Read the schema first; placeholders need safe defaults and video-template scenes need explicit durations.',
                    displayOptions: {
                        show: { resource: ['template'], operation: ['create'] },
                    },
                },
                {
                    ...
                    default: '{}',
                    required: true,
                    description: 'JSON object containing at least one of name, description, or payload (the complete replacement project JSON)',
                    displayOptions: {
                ...
                },
                {
                    ...
                    default: '[]',
                    required: true,
                    description: 'JSON array with one entry per render, e.g. [{"variables": {"name": "Alice"}}, {"variables": {"name": "Bob"}}] (max 500)',
                    displayOptions: {
                        show: {
                            resource: ['render'],
                            operation: ['createBulk'],
                ...
                },
                {
                    ...
                    type: 'boolean',
                    default: false,
                    description: 'Whether to poll the job until it completes (or fails) and return the finished render instead of the queued job',
                    displayOptions: {
                        show: {
                            resource: ['render'],
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            type: 'json',
                            default: '{}',
                            description: 'Output overrides as JSON: name, width, height, resolution, outputFormat, frameRate, backgroundColor, and for images snapshotTime, quality, transparent',
                        },
                        {
                            ...
                            type: 'string',
                            default: '',
                            description: 'Per-job webhook notified on render.completed / render.failed (HMAC-signed)',
                        },
                    ],
                },
                {
                    ...
                    options: [
                        {
                            ...
                            type: 'json',
                            default: '{}',
                            description: 'Output overrides as JSON: name, width, height, resolution, outputFormat, frameRate, backgroundColor',
                        },
                        {
                            displayName: 'Webhook URL',
                            name: 'webhookUrl',
...
exports.Zvid = Zvid;
//# sourceMappingURL=Zvid.node.js.map